...
fn bash_work_cd_script() -> String {
    format!(
        r#"
# Generated by jx shell init bash: enter newly added workspaces, jump to trunk checkouts, and leave removed ones safely.
jx() {{
  if [[ "$1" == "work" && ( "$2" == "add" || "$2" == "trunk" || "$2" == "remove" ) ]]; then
